...
Construire le Cerveau Interne de DevFest Corp
...
**Objectif :** Construire un système intelligent pour "DevFest Corp" totalement hors ligne.
...
- Le modèle tente de répondre : "Qui est le PDG de DevFest Corp ?"
- Le modèle ne peut pas répondre car DevFest Corp n'est pas dans ses données d'entraînement
